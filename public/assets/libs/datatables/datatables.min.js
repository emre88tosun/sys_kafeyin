...
(function (h) {
    ...
    n.defaults = {
        ...
        oLanguage: {
            ...
            sInfo: "_TOTAL_ veriden _START_ - _END_ aralığı gösteriliyor.",
...
(function (d) {
        ...
        action: function (a, b) {
            ...
            for (var g = this.s.dt, f = 0, b = !d.isArray(b) ? [b] : b, h = 0, l = b.length; h < l; h++) {
                ...
                if (o) if (d.isArray(o)) this._expandButton(a, o, c, e); else {
                    ...
                    j && (e !== m ? (a.splice(e, 0, j), e++) : a.push(j), j.conf.buttons && (j.collection = d("<div/>"), j.conf._collection =
                        j.collection, this._expandButton(j.buttons, j.conf.buttons, !0, e)), o.init && o.init.call(g.button(j.node), g, d(j.node), o), f++)
                }
            }
            ...
            c.length && (f = c.eq(0), h());
            var a = d(a), l = d(b.table().container());
    ...
    n.instanceSelector = function (a, b) {
        ...
        var c = [], e = d.map(b, function (a) {
            ...
            if (d.isArray(a)) for (var h = 0, l = a.length; h <
            l; h++) g(a[h]); else "string" === typeof a ? -1 !== a.indexOf(",") ? g(a.split(",")) : (a = d.inArray(d.trim(a), e), -1 !== a && c.push(b[a].inst)) : "number" === typeof a && c.push(b[a].inst)
        };
        g(a);
        return c
    };
    n.buttonSelector = function (a, b) {
        for (var c = [], e = function (a, b, c) {
            ...
            if (d.isArray(a) || a instanceof d) {
                ...
                f = 0;
                for (h = i.length; f <
                h; f++) i[f].name === k && c.push({inst: b, node: i[f].node})
    ...
    n.defaults = {
        buttons: ["copy", "excel", "csv", "pdf", "print"], name: "main", tabIndex: 0, dom: {
            ...
            button: {
                tag: "ActiveXObject" in q ? "a" : "button", className: "dt-button",
    ...
    d.extend(k, {
        collection: {
            ...
            if (k.copyFlash && k.copyFlash.available(a,
                b)) return "copyFlash"
        }, csv: function (a, b) {
        ...
        className: "buttons-copy buttons-html5", text: function (a) {
            ...
            if (k.queryCommandSupported("copy")) {
                ...
                try {
                    ...
                    d.remove();
                    if (h) {
                        b.buttons.info(b.i18n("buttons.copyTitle", "Panoya kopyalandı"), b.i18n("buttons.copySuccess", {
            ...
            h = j("<span>" + b.i18n("buttons.copyKeys", "Press <i>ctrl</i> or <i>⌘</i> + <i>C</i> to copy the table data<br>to your system clipboard.<br><br>To cancel, click this message or press escape.") +
                "</span>").append(d);
            b.buttons.info(b.i18n("buttons.copyTitle", "Panoya kopyalandı"), h, 0);
            c[0].focus();
            c[0].select();
...
(function (e) {
    ...
    i.ext.buttons.print = {
        ...
        text: function (b) {
            return b.i18n("buttons.print", "Yazdır")
        },
...
(function (e) {
    ...
    e.extend(g.ext.buttons, {
        qr: {
            text: p("qr", "Seçililer için QR kod oluştur"),
            className: "buttons-qr-selected",
        ...
        pacify: {
            text: p("pacify", "Seçilileri pasifize et"),
            className: "buttons-pacify-selected",
            limitTo: ["rows", "columns", "cells"],
            init: function (a, c,
                            b) {
                var d = this;
        ...
        selected: {
            ...
            text: p("selectAll", "Tümünü seç"), className: "buttons-select-all", action: function () {
                this[this.select.items() + "s"]().select()
            }
        }, selectNone: {
            text: p("selectNone", "Seçimi kaldır"), className: "buttons-select-none", action: function () {
                o(this.settings()[0], !0)
            }, init: function (a,
                               c, b) {
                var d = this;
