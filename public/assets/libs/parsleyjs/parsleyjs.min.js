!function (t, e) {
    ...
    return h.listen = function (t, e) {
        ...
        defaultMessage: "Girdiğiniz değer geçersiz.",
        type: {
            email: "Girdiğiniz e-posta adresi geçersiz.",
            url: "Girdiğiniz bağlantı geçersiz.",
            number: "Girdiğiniz sayı geçersiz.",
        ...
        min: "Girdiğiniz değer %s den büyük olmalıdır.",
        max: "Girdiğiniz değer %s e eşit veya büyük olmalıdır.",
        range: "Girdiğiniz değer %s ve %s aralığında olmalıdır.",
        minlength: "Girdiğiniz değer çok kısa. En az %s karakter girmelisiniz.",
        maxlength: "Girdiğiniz değer çok uzun. En fazla %s karakter girmelisiniz.",
        length: "This value length is invalid. It should be between %s and %s characters long.",
        mincheck: "En az %s seçenek seçmelisiniz.",
        maxcheck: "En fazla %s seçenek seçmelisiniz.",
        check: "You must select between %s and %s choices.",
        equalto: "Girdiğiniz değer aynı olmalıdır.",
