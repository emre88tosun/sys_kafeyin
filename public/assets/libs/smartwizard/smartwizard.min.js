...
!function (t, s, e, n) {
    ...
    var o = {
        ...
        useURLhash: !0,
        showStepURLhash: !0,
        lang: {next: "Sonraki", previous: "Önceki"},
        toolbarSettings: {
    ...
    t.extend(i.prototype, {
        init: function () {
            ...
            var s = this.options.toolbarSettings.showNextButton !== !1 ? t("<button></button>").text(this.options.lang.next).addClass("btn btn-outline-primary btn-sm sw-btn-next").attr("type", "button") : null,
                e = this.options.toolbarSettings.showPreviousButton !== !1 ? t("<button></button>").text(this.options.lang.previous).addClass("btn btn-outline-primary btn-sm sw-btn-prev").attr("type", "button") : null,
            ...
            if (n && n.length > 0) switch (e) {
                ...
                case"error-off":
                    ...
                    break;
                case"done-on":
                    t(n).parents("li").addClass("done");
                    break;
                case"done-off":
                    t(n).parents("li").removeClass("done")
                    break;
            }
        }
