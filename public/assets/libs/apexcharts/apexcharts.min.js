    ...
    var d = function () {
        ...
        return s(t, [{
            ...
            key: "renderPaths", value: function (t) {
                ...
                var M = A.config.stroke.dashArray, E = 0;
    ...
    var p = {
        ...
        return s(t, [{
            ...
            key: "drawColumnPaths", value: function (t) {
                var e = t.indexes, i = t.x, s = t.y, a = t.xDivision, n = t.pathTo, r = t.pathFrom, o = t.barWidth,
                    ...
                    x = e.realIndex, b = e.bc, m = i + o * this.visibleI;
        ...
        return s(t, [{
            ...
            key: "animateHeatMap", value: function (t, e, i, s, a, n) {
                ...
                r.animateRect(t, {x: e + s / 2, y: i + a / 2, width: 0, height: 0}, {
                    x: e,
                    y: i,
                    width: s,
                    height: a
        ...
        return s(t, [{
            ...
            key: "animateArc", value: function (t, e, i, s, a, n) {
                ...
                l.globals.dataChanged && n.shouldSetPrevPaths && (r = o.getPiePath({
                    ...
                    "pie" !== l.config.chart.type && "donut" !== l.config.chart.type || this.animate(300).attr({"stroke-width": l.config.stroke.width}), n.i === l.config.series.length - 1 && h.animationCompleted()
                }).during(function (l) {
        ...
        return s(t, [{
            ...
            key: "plotChartType", value: function (t, e) {
                ...
                var c = new V(this.ctx, e), d = new E(this.ctx, e), u = new I(this.ctx), g = new F(this.ctx),
    ...
    var at, nt, rt = function () {
        ...
        return s(t, [{
            ...
            key: "moveStickyTooltipOverBars", value: function (t) {
                var e, i = this.w, s = this.ttCtx, a = i.globals.maxValsInArrayIndex + 1,
                    ...
                    r = n ? parseFloat(n.getAttribute("cx")) : 0, o = n ? parseFloat(n.getAttribute("barWidth")) : 0;
            ...
            key: "create", value: function (t, e, i, s, a) {
                ...
                if (r.config.legend.tooltipHoverFormatter) {
                    ...
                    for (var u = 0; u < d.length; u++) {
                        var g = d[u], p = parseInt(g.getAttribute("i")), x = g.getAttribute("data:default-text"),
                            b = c(x, {seriesIndex: n ? p : i, dataPointIndex: s, w: r});
                        if (n) g.innerHTML = r.globals.collapsedSeriesIndices.indexOf(p) < 0 ? b : x; else if (g.innerHTML = p === i ? b : x, i === p) break
                    }
                }
                if (n) {
