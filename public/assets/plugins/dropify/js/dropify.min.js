    ...
    function i(i, t) {
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            var s = {
                ...
                imgFileExtensions: ["png", "jpg", "jpeg", "gif", "bmp", "mp4"],
                ...
                error: {
                    ...
                    imageFormat: "Seçtiğiniz görsel kare biçiminde olmalıdır.",
                    fileExtension: "Dosya uzantısı geçerli değil. (Sadece {{ value }} olmalıdır)"
                },
                tpl: {
