                ...
                <div class="card-body">
                                        ...
                                        <div class="modal-body">
                                            <form enctype="multipart/form-data" method="post"
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="desc" class="col-md-2 col-form-label">Başlık</label>
                                                        <div class="col-md-10">
                    ...
                    <div class="table-responsive mb-3">
                        <table class="table table-hover m-0">
                            ...
                            <tbody>
                            @foreach($pasifEtkinlikler as $etkinlik)
                                <tr>
                                    <th scope="row">{{$etkinlik->id}}</th>
                                    <td>
                                        <div class="popup-gallery" data-source="{{$etkinlik->imageLink}}">
        ...
        <div class="col-xl-2">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text text-muted">Aktif etkinlik sayısı: {{count($aktifEtkinlikler)}}</p>
                    <p class="card-text text-muted">Pasif etkinlik sayısı: {{count($pasifEtkinlikler)}}</p>
                </div>
            </div>
        </div>
    </div>
