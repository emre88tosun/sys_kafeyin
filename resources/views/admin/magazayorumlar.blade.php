                                ...
                                <div class="card-body">
                                    <div class="media border-bottom">
                                        ...
                                        <div class="media-body">
                                            <a href="/adminpanel/kullanicilar/normal/{{$yorum->commenter->id}}" class="mt-0 mb-0 font-size-15">#{{$yorum->commenter->id}} - {{$yorum->commenter->name}} {{$yorum->commenter->surname}}</a>
