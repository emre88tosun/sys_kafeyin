        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb" class="float-right mt-1">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/yoneticipaneli/magazalar/KFYN{{$store->id}}">{{$store->name}} (ID: KFYN{{$store->id}})</a></li>
            ...
            <div class="btn-group mt-2">
                ...
                <div class="dropdown-menu">
                    <a href="/yoneticipaneli/magazalar/KFYN{{$store->id}}/yorumlar?sort=-created_at" type="button" class="dropdown-item @if(request()->sort == null || request()->sort == '-created_at') text-primary @endif ">Yeniden eskiye</a>
                    <a href="/yoneticipaneli/magazalar/KFYN{{$store->id}}/yorumlar?sort=created_at" type="button" class="dropdown-item @if(request()->sort == 'created_at') text-primary @endif ">Eskiden yeniye</a>
                    <a href="/yoneticipaneli/magazalar/KFYN{{$store->id}}/yorumlar?sort=-points" type="button" class="dropdown-item @if(request()->sort == '-points') text-primary @endif ">Azalan puan</a>
                    <a href="/yoneticipaneli/magazalar/KFYN{{$store->id}}/yorumlar?sort=points" type="button" class="dropdown-item @if(request()->sort == 'points') text-primary @endif ">Artan puan</a>
                    <a href="/yoneticipaneli/magazalar/KFYN{{$store->id}}/yorumlar?sort=likes_count" type="button" class="dropdown-item @if(request()->sort == 'likes_count') text-primary @endif ">En çok beğenilen</a>
