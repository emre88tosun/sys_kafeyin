                    ...
                    <div class="media pt-0">
                        <div class="table-responsive table-hover">
                            <table class="table m-0">
                                ...
                                <tr>
                                    <td><a href="/yoneticipaneli/markam/magazalar/KFYN{{$store->id}}/yorumlar">Yorumlar</a></td>
                                </tr>
                                <tr>
                                    <td><a href="/yoneticipaneli/markam/magazalar/KFYN{{$store->id}}/paylasimlar">Paylaşımlar</a></td>
                                </tr>
                                <tr>
                                    <td><a href="/yoneticipaneli/markam/magazalar/KFYN{{$store->id}}/yazilar">Yazılar</a></td>
                                </tr>
                                <tr>
                                    <td><a href="/yoneticipaneli/markam/magazalar/KFYN{{$store->id}}/etkinlikler">Etkinlikler</a></td>
                                </tr>
                                <tr>
                                    <td><a href="/yoneticipaneli/markam/magazalar/KFYN{{$store->id}}/urunler">Ürünler</a></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
